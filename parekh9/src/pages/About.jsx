      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          <motion.div
            ...
            className="text-left"
          >
            <div className="w-12 h-0.5 mb-5 bg-[#A24E51]" />
            <h2 className="font-bold text-3xl sm:text-4xl mb-6 leading-tight text-[#3C3430]"
              style={{ fontFamily: "'Marcellus', serif" }}>
              A Legacy of Excellence
            </h2>
            <p className="leading-[1.8] text-[15px] mb-5 text-[#554D48] font-medium">
            ...
            <p className="leading-[1.8] text-[15px] text-[#554D48] font-medium">
