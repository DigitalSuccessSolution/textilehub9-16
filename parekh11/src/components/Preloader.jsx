...
export default function Preloader() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-[0.02] pointer-events-none bg-[radial-gradient(#4E6C50_1px,transparent_1px)] [background-size:24px_24px]" />

      {/* Large Blurred Watermark Text in Background */}
      <div 
        className="absolute select-none pointer-events-none opacity-[0.06] text-[12vw] sm:text-[10vw] font-bold tracking-[0.15em] text-[#4E6C50] blur-[2.5px] whitespace-nowrap uppercase z-0"
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-6">
        ...
        >
          ...
          <h1
            className="text-3xl sm:text-5xl font-bold tracking-[0.15em] text-[#2C362B] mb-3 uppercase"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            Textile Mall
          </h1>
          <h2
            className="text-[10px] sm:text-[11px] tracking-[0.3em] text-[#8A6F4E] font-bold uppercase mb-8"
