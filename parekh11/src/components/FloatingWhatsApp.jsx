...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-[84px] right-6 z-50 flex items-center justify-center p-2.5 rounded-full text-white transition-all duration-300 hover:scale-105 shadow-lg font-sans"
      style={{
        background: '#1EBE59',
