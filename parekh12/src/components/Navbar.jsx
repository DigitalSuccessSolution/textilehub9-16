        ...
        <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-[75px]">
            ...
            <Link to="/" className="flex items-center gap-2 sm:gap-3 group shrink-0 mx-auto lg:mx-0">
              <div className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center bg-white group-hover:scale-105 transition-transform duration-200 shadow-sm border border-[#C89B5F]/30 text-[#C89B5F]">
              ...
              <div className="flex flex-col text-left">
                <span
                  ...
                  className="text-[#F3F4F6] text-[18px] sm:text-[21px] font-bold tracking-[0.05em] leading-none"
                >
                  SWASTIK TEXTILE MALL
                </span>
                <span
                  className="text-[7.5px] sm:text-[8.5px] tracking-[0.2em] uppercase text-[#C89B5F] leading-tight font-bold mt-1.5"
                >
              ...
              >
                <button
                  className={`relative flex items-center gap-1 px-3 py-2 text-[12.5px] font-bold tracking-wide uppercase transition-colors duration-200 ${
                    isMoreActive ? 'text-[#C89B5F]' : 'text-[#F3F4F6] hover:text-[#C89B5F]'
                  }`}
                >
                  More
                  <ChevronDown
                  ...
                  />
                  {isMoreActive && (
                    <span className="absolute bottom-[-10px] left-1/2 -translate-x-1/2 w-4/5 h-[2px] bg-[#C89B5F]" />
                  )}
                </button>
                        ...
                        <Link
                          ...
                          className={`block px-4 py-2.5 text-[12.5px] font-bold tracking-wide transition-all duration-150 ${
                            isActive
                              ...
                              : 'text-[#F3F4F6] hover:bg-[#C89B5F]/5 hover:text-[#C89B5F] hover:pl-5'
                          }`}
                        >
                          {link.name}
                        </Link>
