                  ...
                  <li key={idx}>
                    ...
                    >
                      ...
                      <div className="flex-grow min-w-0">
                        <p className="text-[13px] font-bold text-[#F3F4F6] truncate group-hover:text-[#C89B5F] transition-colors">{cat.name}</p>
                      </div>
                      <ChevronRight size={13} className="text-[#C89B5F] opacity-50 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all" />
                    </Link>
                  </li>
                ))}
              </ul>
            ...
            <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-sm bg-[#EAE3D9]">
              ...
              >
                ...
                <div 
                  ...
                  style={{
                    background: 'linear-gradient(to right, rgba(10, 10, 12, 0.95) 0%, rgba(10, 10, 12, 0.6) 50%, rgba(10, 10, 12, 0.3) 100%)'
                  }} 
                />
            ...
            <div className="lg:col-span-3 flex flex-col justify-between bg-[#242530] border border-[#C89B5F]/30 text-white p-8 shadow-sm text-left relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-3xl font-normal leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Why Choose<br/>Swastik Textile Mall?
                </h3>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={idx} className="flex items-center gap-3 text-sm font-semibold">
                      <span className="w-5 h-5 bg-[#C89B5F]/20 text-[#C89B5F] flex items-center justify-center shrink-0">✓</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="mt-8 relative z-10">
                <Link
                  to="/about"
                  className="inline-flex items-center justify-center w-full py-3.5 px-6 bg-[#C89B5F] text-black hover:bg-[#D4AF37] transition-all text-xs font-bold tracking-wider uppercase shadow-md shadow-black/10"
                >
                  Know More &rarr;
                </Link>
              </div>
