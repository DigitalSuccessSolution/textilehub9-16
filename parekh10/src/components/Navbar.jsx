...
export default function Navbar() {
  ...
  return (
    <header className="w-full sticky top-0 z-50 transition-all duration-300">
      {/* ── TOP HEADER BANNER ── */}
      <div className="bg-[#5F6F5E] text-white py-2 px-4 sm:px-6 lg:px-8 border-b border-[#2C362B]/20 hidden md:block">
        <div className="max-w-[90rem] mx-auto flex justify-between items-center text-xs font-semibold tracking-wider">
          <div className="flex items-center gap-4">
            <span>India's Leading Textile Retail Mall</span>
          ...
          <div className="flex items-center gap-3">
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="hover:text-[#BCA374] transition-colors"><FacebookIcon /></a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-[#BCA374] transition-colors"><InstagramIcon /></a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:text-[#BCA374] transition-colors"><TwitterIcon /></a>
            <a href="https://youtube.com" target="_blank" rel="noreferrer" className="hover:text-[#BCA374] transition-colors"><YoutubeIcon /></a>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-[75px]">
            ...
            <Link to="/" className="flex items-center gap-2 sm:gap-3 group shrink-0 mx-auto lg:mx-0">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center border border-[#5F6F5E]/30 bg-white group-hover:scale-105 transition-transform duration-200 shadow-sm">
                <svg viewBox="0 0 100 100" className="w-6 h-6 text-[#5F6F5E]" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col">
                <span
                  ...
                  className="text-[#2C362B] text-[17px] sm:text-[22px] font-bold tracking-[0.1em] leading-none"
                >
                  SANDHYA
                </span>
                <span
                  className="text-[8px] sm:text-[9.5px] tracking-[0.25em] uppercase text-[#8A6F4E] leading-tight font-bold mt-1"
                >
                  TEXTILE MALL
                </span>
              </div>
