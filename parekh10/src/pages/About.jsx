      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 py-10 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-md">
              <img
                ...
                alt="About Sandhya Textile Mall"
          ...
          <motion.div
            ...
            className="text-left"
          >
            <div className="w-12 h-[2px] mb-5 bg-[#5F6F5E]" />
            <h2 className="font-bold text-3xl sm:text-4xl mb-6 leading-tight text-[#2C362B]"
              style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              A Legacy of Excellence
            </h2>
            <p className="leading-[1.8] text-[15px] mb-5 text-[#454B45] font-medium">
            ...
            <p className="leading-[1.8] text-[15px] text-[#454B45] font-medium">
