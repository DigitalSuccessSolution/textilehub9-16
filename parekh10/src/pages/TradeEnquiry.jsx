  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#FAF8F5' }}>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        <p className="text-center text-[15px] leading-[1.8] mb-10 text-[#5D645D] font-medium">
          ...
          <div className="p-8 md:p-12">
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-5">
                <h3 className="font-bold text-xl pb-3 border-b text-[#2C362B]"
                  style={{ fontFamily: "'Cormorant Garamond', serif", borderColor: '#E8E3D9' }}>
                  Company Details
                </h3>
                  ...
                  {[{ label: 'Company Name *', type: 'text' }, { label: 'Contact Person *', type: 'text' }].map((f, i) => (
                    <div key={i} className="space-y-1.5">
                      ...
                      <input type={f.type} required
                        ...
                        style={{ background: '#FAF8F5', border: '1.5px solid #E8E3D9', color: '#2C362B' }}
