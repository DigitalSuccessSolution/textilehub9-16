  ...
  return (
    <div className="pb-20" style={{ fontFamily: "'Outfit', sans-serif", background: '#FAF6F0' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-white border border-[#EADBC8] p-5 rounded-2xl shadow-sm mb-10 max-w-3xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            
            {/* Search Input Box */}
            <div className="relative flex items-center">
              <Search className="absolute left-4 text-[#786B80] pointer-events-none" size={18} />
              <input
                type="text"
            ...
            <div className="relative flex items-center">
              ...
              <ChevronDown className="absolute right-4 text-[#786B80] pointer-events-none" size={16} />
            </div>
        ...
        {filteredProducts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-left max-w-6xl mx-auto">
            {filteredProducts.map(product => (
              ...
              >
                <div className="h-64 w-full relative overflow-hidden bg-[#FAF6F0]">
                  <img
                    src={product.image}
                    alt={product.name}
                ...
                <div className="p-5 text-center border-t border-[#EADBC8]">
                  <p className="text-[10px] uppercase tracking-widest font-extrabold mb-1 text-[#C5A059]">
                    {product.category}
                  </p>
                  <h3 className="font-extrabold text-lg text-[#2A083E]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                    {product.name}
                  </h3>
                </div>
              </motion.div>
